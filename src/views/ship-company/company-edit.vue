...
import { updateCompanyInfo } from '@/api/ship-company-data.js';
...
export default {
  ...
  created() {
    ...
    this.form.address = this.formInfo.address;
    this.form.legalPerson = this.formInfo.legalPerson;
    this.form.phone = this.formInfo.phone;
    this.form.createTime = this.formInfo.createTime;
    this.form.desc = this.formInfo.desc;
  },
  methods: {
    onSubmit() {
    ...
    updateCompanyInfo() {
      updateCompanyInfo(this.formInfo).then(res => {
